export default {
  ...
  "privilege.readonly": "授权只读",
  "privilege.readwrite": "授权读写",
  "privilege.all": "读写",
  ...
  "restore.title": "解冻",
  restore: "解冻",
  "restoreModal.message1": "将解冻以下目录或文件",
  "restoreModal.message2": "用户取消解冻",
  "restoreModal.message3": "部分目录或文件无法解冻",
  "restoreModal.success": "提交成功",
  "restore.tooltip.frozen": "冻结",
  "restore.tooltip.unfreezing": "解冻中",
  "restore.tooltip.unfrozen": "已解冻",
  "restore.message.frozen": "归档存储文件已经冻结",
  "restore.message.unfreezing": "归档存储文件正在解冻中",
  "restore.message.unfrozen": "归档存储文件已解冻",
  "restore.message.head_error": "获取归档存储文件状态失败",

  updateStorageClass: "修改存储类型",
  "updateStorageClass.title": "修改存储类型",
  "updateStorageClass.text1": "归档存储类型的文件需要先解冻为可读取状态，才能进行类型转换。",
  "updateStorageClass.current": "当前存储类型",
  "updateStorageClass.setTo": "修改为",
  "updateStorageClass.on": "正在修改...",
  "updateStorageClass.success": "修改存储类型成功",
  ...
  "upload.job.pause": "暂停任务",
  "upload.job.remove": "移除任务",
  "upload.job.retry": "重试上传",
  "upload.job.retry.overwrite": "重试覆盖上传",
  "download.overwrite": "开启覆盖下载",
  "download.overwrite.disabled": "禁用覆盖下载",
  "download.job.pause": "暂停任务",
  "download.job.remove": "移除任务",
  "download.job.retry": "重试下载",
  "start.all": "启动全部",
  "pause.all": "暂停全部",
