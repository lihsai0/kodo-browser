export default {
  ...
  "upload.job.pause": "pause",
  "upload.job.remove": "remove",
  "upload.job.retry": "retry",
  "upload.job.retry.overwrite": "overwrite retry",
  "download.overwrite": "Enable overwrite for downloading",
  "download.overwrite.disabled": "Disable overwrite for downloading",
  "download.job.pause": "pause",
  "download.job.remove": "remove",
  "download.job.retry": "retry",
  "start.all": "Start All",
  "pause.all": "Stop All",
