module.exports = {
  ...
  "restore.title": "リストア",
  restore: "リストア",
  "restoreModal.message1": "次のディレクトリまたはファイルが復元されます",
  "restoreModal.message2": "キャンセルされました",
  "restoreModal.message3": "一部のディレクトリまたはファイルは復元できません",
  "restoreModal.success": "正常に復元されました",
  "restore.tooltip.frozen": "フローズン",
  "restore.tooltip.unfreezing": "不凍",
  "restore.tooltip.unfrozen": "凍結されていない",
  "restore.message.frozen": "アーカイブストレージファイルが凍結されました",
  ...
  updateStorageClass: "ストレージクラスを設定する",
  "updateStorageClass.title": "ストレージクラスを設定する",
  "updateStorageClass.text1": "アーカイブストレージタイプのファイルは、タイプ変換を実行する前に、読み取り可能な状態に解凍する必要があります。",
  "updateStorageClass.text2": "低頻度ストレージおよびアーカイブストレージタイプで、オブジェクトの最小測定値は64KBです。",
  "updateStorageClass.text3": "低頻度タイプから他のタイプに変換する場合、オブジェクトの保存期間が30日未満の場合、30日として請求されます。",
  "updateStorageClass.text4": "アーカイブ保管タイプから他のタイプに変換する場合、オブジェクトの保管期間が60日未満の場合、60日として請求されます。",
  "updateStorageClass.current": "現在のストレージクラス",
  "updateStorageClass.setTo": "着替える",
  "updateStorageClass.on": "更新...",
  "updateStorageClass.success": "ストレージクラスが正常に変更されました",
